...
console.log(matilda, jack); //Person {firstName: 'Matilda', birthYear: 2017}   
...
console.log(jonas.__proto__); // Object  {calcAge: ƒ}
...
const arr = [3, 6, 6, 5, 6, 9, 9]; // [[Prototype]]: Array(0)
...
class PersonCL {
    ...
    greet() {
        console.log(`Hey ${this.firstName}`); // Hey Jessics
    }
    ...
    set fullName(name) {
        // console.log(name); // Jessics Devis
...
const jessica = new PersonCL('Jessics Devis', 1996);
console.log(jessica); // PersonCL {firstName: 'Jessics', birthYear: 1996}
jessica.calcAge(); // 41
...
class StudentCl extends PersonCl {
    ...
    calcAge() {
        console.log(`I'm ${2037 - this.birthYear} year's old, but as a student I feel more like ${2037 - this.birthYear + 10}`);
    }
};
...
/*
// 20. Encapsulation Protected Properties and Methods _;
...
class Account {
  // 1) Public fields (instamces) 21
  locale = navigator.language;

  // 2) Private fields (instamces) 21
  #movements = [];
  #pin;
  ...
  // 3) Public Methodss (21) or // public interface
  getMovements() {
  ...
  // (there is also the static version) 21
  static helper () {
    console.log('helper!');
    
  }

  // 4) Private Methods (21)
  // #approveLoan(val) {
  _approveLoan(val) {
    return true;
  }
...
const acc1 = new Account('junas', 'EUR', 1111);
...
acc1.deposit(300).deposit(500).withdrawal(35).requestLoan(35000).withdrawal(5000);
console.log(acc1.getMovements());
*/
