...
const movementsDescription = movements.map((mov, i) => 
    ...
    `Movements ${i + 1} you ${mov > 0 ? 'deposited' : 'withdraw'}  ${Math.abs(mov)}`
);
...
const deposie = movements.filter(function (mov, i, arr) {
  return mov > 0;
});
console.log(movements);
console.log(deposie);
...
const deposiesfor = [];
for(const mov of movements) if (mov > 0) deposiesfor.push(mov);
console.log(deposiesfor);
...
const deposit = mov => mov < 0; // [-400, -650, -130]
...
// const z = Array.from({length: 7}, (___,  i) => i + 1);
console.log(z);
...
8. Craete a shallow copy of the dogs array and sort it by recommended food portion in as ascending order (keep in mind that) the portion inside the array`s object.
///////////////////////////////////////////
...
// 8).
// sort it by recommended food portion in as ascending order [1,2,3,...]
