...
const lufthansa = {
   ...
   book (flightNum, name) {
      ...
      this.bookings.push({flght: `${this.iataCode}${flightNum}`, name})
   },
}
...
// Immediately Invoked Function Expressions (1)
(function() {
    console.log('This will never run again');
    const isPruvate = 23;
})();

// console.log(isPruvate);
...
const boardPassengers = function(n, wait) {
   ...
   console.log(`will start in boarding in ${wait} second`);  
}
